                ...
                <div class="card-body">
                    ...
                    <?php if($usuario->perfilesActivos < 2): ?> <a href="/perfil/create">
                        ...
                        <?php if($usuario->perfilesActivos < 4): ?> <a href="/perfil/create">
                            <div style="text-align: center;"  class="button btn-primary">Nuevo perfil</div>
                            </a>
                            <?php endif; ?>
                            <?php endif; ?>
...
<?php echo $__env->make('layouts.appUsers', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Administrator\Bookflix\resources\views/user/perfiles/index.blade.php ENDPATH**/ ?>