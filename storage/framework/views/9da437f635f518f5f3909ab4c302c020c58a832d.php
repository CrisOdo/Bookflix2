    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="/book/updateC/<?php echo e($libro->id); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <form action="/chapter/delete/<?php echo e($chapter['id']); ?>" enctype="multipart/form-data" method="GET">
                        <?php echo csrf_field(); ?>
                        <div class="form-group row">
                            <label for="chapterName" class="col-md-4 col-form-label text-md-right"><?php echo e($chapter['name']); ?></label>
...
<?php echo $__env->make('admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Administrator\Bookflix\resources\views/admin/book/editC.blade.php ENDPATH**/ ?>