...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header"><?php echo e(__('Ingrese los datos de un nuevo libro')); ?></div>
                <div class="card-body">
                    <form action="/be" enctype="multipart/form-data" method="POST">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="isbn" type="text" class="form-control <?php $__errorArgs = ['isbn'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="isbn" value="<?php echo e(old('isbn')); ?>" autocomplete="isbn" autofocus>
...
unset($__errorArgs, $__bag); ?>" name="genre_id" value="<?php echo e(old('genre_id')); ?>" autocomplete="genre_id" autofocus>>
...
unset($__errorArgs, $__bag); ?>" name="author_id" value="<?php echo e(old('author_id')); ?>" autocomplete="author_id" autofocus>>
...
unset($__errorArgs, $__bag); ?>" name="editorial_id" value="<?php echo e(old('editorial_id')); ?>" autocomplete="editorial_id" autofocus>>
...
unset($__errorArgs, $__bag); ?>" name="disponibleDesde" value="<?php echo e(old('disponibleDesde')); ?>" autocomplete="disponibleDesde" autofocus>
...
unset($__errorArgs, $__bag); ?>" name="disponibleHasta" value="<?php echo e(old('disponibleHasta')); ?>" autocomplete="disponibleHasta" autofocus>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="adelanto" type="file" class="form-control <?php $__errorArgs = ['adelanto'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="adelanto" value="<?php echo e(old('adelanto')); ?>" autofocus>
...
<?php echo $__env->make('admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Administrator\Bookflix\resources\views/admin/book/createEntero.blade.php ENDPATH**/ ?>