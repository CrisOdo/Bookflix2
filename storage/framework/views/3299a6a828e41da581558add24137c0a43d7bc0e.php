    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="/book/update/<?php echo e($libro->id); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" name="editorial_id" value="<?php echo e($libro->editorial_id); ?>" autocomplete="editorial_id" autofocus selected>
...
<?php echo $__env->make('admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Administrator\Bookflix\resources\views/admin/book/edit.blade.php ENDPATH**/ ?>