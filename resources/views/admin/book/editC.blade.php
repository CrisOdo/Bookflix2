    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="/book/updateC/{{$libro->id}}" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                    ...
                    <form action="/chapter/delete/{{$chapter['id']}}" enctype="multipart/form-data" method="GET">
                        @csrf
                        <div class="form-group row">
                            <label for="chapterName" class="col-md-4 col-form-label text-md-right">{{$chapter['name']}}</label>
