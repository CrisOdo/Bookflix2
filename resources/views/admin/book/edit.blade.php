    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="/book/update/{{$libro->id}}" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select id="editorial_id" type="text" class="form-control @error('editorial_id') is-invalid @enderror" name="editorial_id" value="{{$libro->editorial_id}}" autocomplete="editorial_id" autofocus selected>
